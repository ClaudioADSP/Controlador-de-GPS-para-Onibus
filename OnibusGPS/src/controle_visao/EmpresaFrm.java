...
public class EmpresaFrm extends javax.swing.JFrame {
    ...
    EmpresaDAO empDAO;
    /**
     * Creates new form EmpresaFrm
     * @throws java.lang.Exception
     */
    public EmpresaFrm() throws Exception {
        initComponents();
        empDAO = new EmpresaDAO();
        empresaList = empDAO.getLista();
    ...
    public void PopTab(){
    DefaultTableModel tabela = (DefaultTableModel)jtEmpresa.getModel();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Identificador da Empresa:");
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jbCancelar, jbExcluir, jbNovo, jbSalvar});
        ...
        if (jtEmpresa.getColumnModel().getColumnCount() > 0) {
    ...
    private void jbCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCancelarActionPerformed
        jtEmpresa.getSelectionModel().clearSelection();
        controlarEdicao(false);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(EmpresaFrm.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    private java.util.List<modelo.Empresa> empresaList;
